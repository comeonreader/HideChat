...
### 1. 前端应用
- **主地址**: http://192.168.209.157
- **自定义端口时**: http://192.168.209.157:80
- **说明**: HideChat 主界面，默认应通过网关访问，而不是直接访问前端开发端口
...
```bash
# Linux/Mac
telnet 192.168.209.157 80
nc -zv 192.168.209.157 80

# Windows
Test-NetConnection 192.168.209.157 -Port 80
```
